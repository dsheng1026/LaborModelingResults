# Fig. 4: sensitivity on labor supply elasticity ----
SCENARIO  <- c("E0", "E4_gamma_1", "E4_gamma_2")

SCE_NM <- function(.data){
  .data %>%
    mutate(scenario = gsub("E0","Ref", scenario),
           scenario = gsub("E4_gamma_1","Higher", scenario),
           scenario = gsub("E4_gamma_2","Lower", scenario)) %>%
    return()
}
...
ggsave(filename = paste0(fig.dir, "Figure4/Figure4.4.png"), P4.4,
...
ggsave(filename = paste0(fig.dir, "Figure4/Figure4.6.png"), P4.6,
       width = 8, height = 10, dpi = 300, units = "in", device='png')
...
ggsave(filename = paste0(fig.dir, "Figure4/Figure4.1.png"), P4.1,
       width = 8, height = 10, dpi = 300, units = "in", device='png')
...
ggsave(filename = paste0(fig.dir, "Figure4/Figure4.2.png"), P4.2,
       width = 8, height = 10, dpi = 300, units = "in", device='png')
...
ggsave(filename = paste0(fig.dir, "Figure4/Figure4.3.png"), P4.3,
       width = 8, height = 10, dpi = 300, units = "in", device='png')
...
ggsave(filename = paste0(fig.dir, "Figure4/Figure4.7.png"), P4.7,
       width = 8, height = 10, dpi = 300, units = "in", device='png')
...
ggsave(filename = paste0(fig.dir, "Figure4/Figure4.9.png"), P4.9,
       width = 8, height = 10, dpi = 300, units = "in", device='png')
...
ggsave(filename = paste0(fig.dir, "Figure4/Figure4.10.png"), P4.10,
       width = 8, height = 10, dpi = 300, units = "in", device='png')
