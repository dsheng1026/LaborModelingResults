# Fig. 5: sensitivity on theta ----
SCENARIO  <- c("E0", "E4_theta_higher", "E4_theta_lower")

SCE_NM <- function(.data){
  .data %>%
    mutate(scenario = gsub("E0","Ref", scenario),
           scenario = gsub("E4_theta_higher","Higher", scenario),
           scenario = gsub("E4_theta_lower","Lower", scenario)) %>%
    return()
}
...
ggsave(filename = paste0(fig.dir, "Figure5/Figure5.4.png"), P4.4,
...
ggsave(filename = paste0(fig.dir, "Figure5/Figure5.6.png"), P4.6,
       width = 8, height = 10, dpi = 300, units = "in", device='png')
...
ggsave(filename = paste0(fig.dir, "Figure5/Figure5.1.png"), P4.1,
       width = 8, height = 10, dpi = 300, units = "in", device='png')
...
ggsave(filename = paste0(fig.dir, "Figure5/Figure5.2.png"), P4.2,
       width = 8, height = 10, dpi = 300, units = "in", device='png')
...
ggsave(filename = paste0(fig.dir, "Figure5/Figure5.3.png"), P4.3,
       width = 8, height = 10, dpi = 300, units = "in", device='png')
...
ggsave(filename = paste0(fig.dir, "Figure5/Figure5.7.png"), P4.7,
       width = 8, height = 10, dpi = 300, units = "in", device='png')
...
ggsave(filename = paste0(fig.dir, "Figure5/Figure5.9.png"), P4.9,
       width = 8, height = 10, dpi = 300, units = "in", device='png')
...
ggsave(filename = paste0(fig.dir, "Figure5/Figure5.10.png"), P4.10,
       width = 8, height = 10, dpi = 300, units = "in", device='png')
