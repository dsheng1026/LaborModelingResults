...
ggsave(filename = paste0(fig.dir, "Ref/Ref.4.png"), P2.4,
...
ggsave(filename = paste0(fig.dir, "Ref/Ref.2.png"), P2.2,
       width = 8, height = 10, dpi = 300, units = "in", device='png')
...
ggsave(filename = paste0(fig.dir, "Ref/Ref.3.png"), P2.3,
       width = 8, height = 10, dpi = 300, units = "in", device='png')
...
ggsave(filename = paste0(fig.dir, "Ref/Ref.7.png"), P2.7,
       width = 8, height = 10, dpi = 300, units = "in", device='png')
...
ggsave(filename = paste0(fig.dir, "Ref/Ref.8.png"), P2.8,
       width = 8, height = 10, dpi = 300, units = "in", device='png')
...
ggsave(filename = paste0(fig.dir, "Ref/Ref.9.png"), P2.9,
       width = 8, height = 10, dpi = 300, units = "in", device='png')
...
ggsave(filename = paste0(fig.dir, "Ref/Ref.10.png"), P2.10,
       width = 8, height = 10, dpi = 300, units = "in", device='png')
